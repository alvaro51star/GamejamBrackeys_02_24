...
~preguntasCounter++
    He died... Although, well, I guess he's in a better place now.... #speaker:{characterName} #portrait:otherPerson
    ->selector

*Aren't you back too soon?#speaker:you #portrait:you
~preguntasCounter++
    They killed my partner so I had to come back early. #speaker:{characterName} #portrait:otherPerson
    ->selector
    
*There's a lot of resources missing.#speaker:you #portrait:you
~preguntasCounter++
    I gave some of the resources to a family that needed it more than we did. #speaker:{characterName} #portrait:otherPerson
    ->selector
